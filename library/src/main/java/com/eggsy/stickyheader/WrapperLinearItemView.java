...
/**
 * @author eggsy
 *         created at 2017/5/19 19:28
 */
public class WrapperLinearItemView extends ViewGroup {

    RecyclerView.ViewHolder mItemViewHolder;
    View mItem;
    View mHeader;
    int mItemTop;

    public WrapperLinearItemView(Context context) {
        super(context);
    }
